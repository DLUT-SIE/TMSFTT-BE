    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            options={
                ...
                'permissions': (('add_coefficient', '允许添加活动系数'), ('view_coefficient', '允许查看活动系数'), ('change_coefficient', '允许修改培活动系数'), ('delete_coefficient', '允许删除培活动系数')),
                'default_permissions': (),
            },
        ),
        migrations.CreateModel(
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, to='training_event.OffCampusEvent', verbose_name='校外培训活动'),
        ),
