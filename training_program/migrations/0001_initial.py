    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='training_program.ProgramCategory', verbose_name='培训类别')),
                ('department', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='tmsftt_auth.Department', verbose_name='开设单位')),
                ('form', models.ManyToManyField(blank=True, to='training_program.ProgramForm', verbose_name='培训形式')),
            ],
            options={
                'verbose_name': '培训项目',
