# Generated by Django 2.1.5 on 2019-04-24 12:50
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.PositiveSmallIntegerField(choices=[(1, '已提交'), (2, '院系管理员已审核'), (3, '学校管理员已审核'), (4, '培训反馈待提交'), (5, '培训反馈已提交')], default=1, verbose_name='当前状态')),
