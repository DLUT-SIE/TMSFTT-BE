    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.PositiveSmallIntegerField(choices=[(1, '已提交'), (2, '院系管理员审核通过'), (3, '学校管理员审核通过'), (4, '培训反馈待提交'), (5, '培训反馈已提交'), (6, '院系管理员审核不通过'), (7, '学校管理员审核不通过'), (8, '状态关闭')], default=1, verbose_name='当前状态')),
                ('campus_event', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, related_name='records', to='training_event.CampusEvent', verbose_name='校内培训活动')),
                ('event_coefficient', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='records', to='training_event.EventCoefficient', verbose_name='培训活动系数')),
            ...
            options={
                ...
                'permissions': (('add_record', '允许添加培训记录'), ('view_record', '允许查看培训记录'), ('change_record', '允许修改培训记录'), ('delete_record', '允许删除培训记录'), ('review_record', '允许审核培训记录'), ('batchadd_record', '允许批量增加培训记录')),
                'default_permissions': (),
            },
        ),
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('pre_status', models.PositiveSmallIntegerField(blank=True, choices=[(1, '已提交'), (2, '院系管理员审核通过'), (3, '学校管理员审核通过'), (4, '培训反馈待提交'), (5, '培训反馈已提交'), (6, '院系管理员审核不通过'), (7, '学校管理员审核不通过'), (8, '状态关闭')], null=True, verbose_name='更改前状态')),
                ('post_status', models.PositiveSmallIntegerField(blank=True, choices=[(1, '已提交'), (2, '院系管理员审核通过'), (3, '学校管理员审核通过'), (4, '培训反馈待提交'), (5, '培训反馈已提交'), (6, '院系管理员审核不通过'), (7, '学校管理员审核不通过'), (8, '状态关闭')], null=True, verbose_name='更改后状态')),
        ...
        migrations.CreateModel(
            ...
            options={
                ...
                'permissions': (('view_recordcontent', '允许查看培训记录内容'),),
                'default_permissions': (),
            },
        ),
        migrations.CreateModel(
            ...
            options={
                ...
                'permissions': (('view_recordattachment', '允许查看培训记录附件'),),
                'default_permissions': (),
            },
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('record', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='feedback', to='training_record.Record', verbose_name='培训记录')),
            ],
            options={
                'verbose_name': '培训活动反馈',
                'verbose_name_plural': '培训活动反馈',
                'permissions': (('add_campuseventfeedback', '允许增加培训活动反馈'),),
                'default_permissions': (),
            },
        ),
    ]
