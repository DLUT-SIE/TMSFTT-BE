...
class TestRecordService(TestCase):
    ...
    def setUpTestData(cls):
        ...
        cls.off_campus_event = mommy.make(OffCampusEvent)
    ...
    def test_create_off_campus_record_no_contents_and_attachments(self):
        ...
        self.assertEqual(RecordContent.objects.all().count(), 0)
        self.assertEqual(RecordAttachment.objects.all().count(), 0)
    ...
    def test_create_off_campus_record(self):
        ...
        self.assertEqual(RecordContent.objects.all().count(), 2)
        self.assertEqual(RecordAttachment.objects.all().count(), 2)
