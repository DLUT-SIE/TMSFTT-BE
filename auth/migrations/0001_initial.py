    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('raw_user_id', models.CharField(max_length=20, unique=True, verbose_name='用户原始ID')),
                ...
                ('education_backgroun', models.CharField(blank=True, max_length=40, null=True, verbose_name='学历')),
