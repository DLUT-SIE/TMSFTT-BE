    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('dwlx', models.CharField(blank=True, db_column='DWLX', max_length=4, null=True, verbose_name='单位类型')),
            ],
            options={
                'verbose_name': '单位基本信息',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('yxdz', models.CharField(blank=True, db_column='YXDZ', max_length=40, null=True, verbose_name='邮箱地址')),
                ('sjh', models.CharField(blank=True, db_column='SJH', max_length=40, null=True, verbose_name='手机号')),
            ],
            options={
                'verbose_name': '教师基本信息',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('department_type', models.CharField(blank=True, choices=[('T1', '职能部处'), ('T2', '直附属单位'), ('T3', '学部院系'), ('T4', '其他'), ('T5', '职能部门及直附属单位'), ('T6', '书院'), ('T7', '学院'), ('T8', '其他机构')], max_length=2, null=True, verbose_name='单位类型')),
                ('super_department', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, related_name='child_departments', to='tmsftt_auth.Department', verbose_name='所属机构')),
            ],
            options={
                'verbose_name': '院系',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cell_phone_number', models.CharField(blank=True, max_length=40, null=True, verbose_name='手机号')),
                ('administrative_department', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, related_name='administrative_users', to='tmsftt_auth.Department', verbose_name='所属行政单位')),
                ('department', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, related_name='users', to='tmsftt_auth.Department', verbose_name='所属院系')),
