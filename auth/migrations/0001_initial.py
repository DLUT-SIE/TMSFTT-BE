...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('auth', '0011_remove_group_available'),
    ]
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(max_length=80, unique=True, verbose_name='院系')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('department', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='tmsftt_auth.Department', verbose_name='院系')),
        ...
        migrations.AddField(
            model_name='user',
            name='roles',
            field=models.ManyToManyField(blank=True, null=True, related_name='users', to='tmsftt_auth.Role'),
        ),
        migrations.AddField(
            model_name='user',
